...
const HeaderBar = () => (
  <div id="header-bar">
    <div className='header-item'>
      <i className="fas fa-align-right fa-2x" style={{ 'transform': 'rotate(180deg)', 'color': 'white', 'cursor': 'pointer' }}onClick={() => { window.location.href = '/admin' }}></i>
    ...
    <div className='header-item'>
      <div className="header-text" style={{ 'marginRight': '1.5rem' }} onClick={() => { window.location.href = '/login' }}>Log In</div>
