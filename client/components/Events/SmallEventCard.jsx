...
&nbsp;
    ...
    return (
      <>
        <div className="event-info-card">
          <img onClick={this.onModalOpen} className="event-info-card-photo clickable-image" height="180" width="290" src={event.thumbnail_photo ? event.thumbnail_photo : null} alt="photo" />
          <br />
