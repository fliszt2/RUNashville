...
const Profile = class extends React.PureComponent {
  ...
  updateDisplayedProfile(userID) {
    this.setState({ currentUserID: userID }, () => {
      axios.get(`http://ec2-18-218-172-21.us-east-2.compute.amazonaws.com:3000/api/user/${this.state.currentUserID}`)
        .then((newProfile) => {
          axios.get(`http://ec2-18-218-172-21.us-east-2.compute.amazonaws.com:3000/api/friends/${this.state.currentUserID}`)
            .then((newFriends) => {
              axios.get(`http://ec2-18-218-172-21.us-east-2.compute.amazonaws.com:3000/api/events/${this.state.currentUserID}`)
                .then((newEvents) => {
                  axios.get(`http://ec2-18-218-172-21.us-east-2.compute.amazonaws.com:3000/api/post?id=${this.state.currentUserID}`)
                    .then((newPosts) => {
